...
def generar_invitados():
    nombres_invitados = []
    for i in range(3):
        nombres_invitados.append(str(input("Ingrese el nombre del invitado:")))

    return nombres_invitados
# --------------------------------
...
if __name__ == '__main__':
    ...
    print("El orden alfabético de la lista es:", lista_invidatos_ordenada)
